<div id="wysihtml-toolbar" class="edy-tb">
    ...
    <div class="edy-tb-menucontainer">
        ...
        <div class="edy-tb-stylemenu" style="display: none;">
            <button class="edy-tb-cmd edy-tb-style-h1" data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="h1" style="font-weight: 300; font-family: Montserrat, 'Helvetica Neue', Helvetica, Arial, sans-serif;" unselectable="on">Title</button>
