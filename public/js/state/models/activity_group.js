CSLP.State.Models.ActivityGroup = Backbone.Model.extend({
    ...
    addNewActivity : function(activity, type){
        this.add(activity);
        ...
        $.post(basePath + '/maker/newactivity',{
            ...
            activity.attributes.questions = response.questions;
        });
        
    },

    initCollection : function(){
        this.attributes.activitiesCollection = new CSLP.State.Collections.Activities;
    ...
    generateView : function(){
        this.view = new CSLP.State.Views.ActivityGroup({
            model : this
        });
    },
