...
@section('content')
    ...
    <div class="form-container">
        <div class="img-login">
            <fieldset>
                <legend>¡Bienvenid@ a Problock!</legend>
                <picture>
                    <img src="{!! asset('/images/imgLogin.png') !!}" alt="Ejemplo">
                </picture>
            </fieldset>
        </div>
        <br>
    ...
    <div class="register">
        <p>¿Deseas crear una cuenta? </p><a href="{!! url('signup') !!}"> Registrate aquí</a>
    </div>
@stop
